...
export default function WorkerYouthPage({ params }: YouthPageProps) {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(217,95,72,0.12),_transparent_28%),linear-gradient(180deg,_#f8fbfa_0%,_#ffffff_50%,_#f4f7fb_100%)] px-4 py-6 sm:px-6 lg:px-8">
