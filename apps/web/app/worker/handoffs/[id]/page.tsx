...
export default function HandoffBriefPage({ params }: HandoffPageProps) {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_right,_rgba(183,121,31,0.16),_transparent_26%),linear-gradient(180deg,_#f8fbfa_0%,_#ffffff_54%,_#f6f8fb_100%)] px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
                  Worker-ready summary with the minimum context needed to pick
                  up the conversation without making the youth repeat the full
                  story.
                </p>
              </div>
              <span
            ...
            <aside className="grid content-start gap-4">
              <div className="rounded-[24px] border border-slate-200 bg-[linear-gradient(180deg,_rgba(31,111,100,0.08),_rgba(255,255,255,1))] p-5">
                ...
                <div className="mt-4 space-y-3">
                  ...
                  <p className="rounded-2xl bg-white/90 p-4 text-sm leading-6 text-slate-700 shadow-sm">
                    <span className="font-semibold text-ink">Last active:</span>{" "}
                    {youth.lastActive}
                  </p>
                </div>
              </div>
