      ...
      <div className="grid grid-cols-3 gap-3">
        {([
          ...
          <div key={name} className="glass-card p-4">
            ...
            <p className="text-[32px] font-semibold" style={{ color, letterSpacing: "-0.03em" }}>
              {value}
            </p>
          </div>
        ))}
      ...
      <div className="space-y-3">
              ...
              {item.handoffId && (
                <Link
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(111,184,170,0.3)",
                    color: "#6fb8aa",
                  }}
                >
                  Open Handoff {"->"}
        ...
        {!loading && !error && items.length === 0 && (
          <div className="glass-card p-8 text-center">
            <p className="text-[rgba(214,235,230,0.5)] text-sm">
