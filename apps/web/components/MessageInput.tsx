  ...
  return (
    <form className="flex items-end gap-3 border-t border-slate-200 bg-white p-4" onSubmit={handleSubmit}>
      ...
      <button
        ...
        className="grid h-11 w-11 place-items-center rounded-lg bg-pine text-white transition hover:bg-pine/90 disabled:cursor-not-allowed disabled:bg-slate-300"
      >
