...
const channelColors: Record<string, { bg: string; border: string; color: string }> = {
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              <h3 className="text-[16px] font-semibold text-[#f1f6f4]">{youth.youthName}</h3>
              <span
            ...
            <p className="font-mono text-[12px] text-[rgba(214,235,230,0.35)]">Last active: {youth.lastActive}</p>
          </div>
      ...
      <div className="space-y-4 px-5 py-4">
        <div>
          ...
          <div className="space-y-3 rounded-[14px] p-3" style={{ background: "rgba(0,0,0,0.2)" }}>
            {youth.conversationPreview.map((turn) => {
              ...
              return (
                <div
                  key={`${youth.id}-${turn.timestamp}-${turn.sender}-${turn.message}`}
                ...
                >
                  ...
                  >
                    <div className="mb-1 flex items-center gap-2 text-[10px] font-semibold uppercase tracking-[0.12em] opacity-50">
        ...
        <div className="flex justify-end pt-1">
          <Link
            ...
            className="inline-flex items-center gap-1.5 text-[12.5px] font-semibold text-[#6fb8aa] transition-colors hover:text-[#8fcfc3]"
          >
            Open youth case
